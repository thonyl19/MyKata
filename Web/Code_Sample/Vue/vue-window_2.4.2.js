...
*/
var __fn = ($,_,Vue,vue_window)=>{
	debugger
	if(Vue!=null) Vue.use(vue_window);
	WINDOW_STYLE_KEY = '@hscmap/vue-window/windowStyle';
	window.addEventListener('load', function () {
		debugger
		var sampleId = location.search || '?Sample1'
		var as = document.querySelectorAll('a')
		for (var i = 0; i < as.length; i++) {
		  var a = as.item(i)
		  '?' + a.href.split('?')[1] == sampleId && a.classList.add('active')
		}
	  })
...
(function () {
	/*
	ExAdm 版需搭配才能使用
	npm i --save @hscmap/vue-window
	*/
	var cfg = {
		paths: {
			'vue-window':[
				"../node_modules/@hscmap/vue-window/standalone/dist/vue-window-standalone"
				,"https://cdn.jsdelivr.net/npm/@hscmap/vue-window@2.4.2/standalone/dist/vue-window-standalone"
			]
			,"base64-js":[
				//"https://cdnjs.cloudflare.com/ajax/libs/Base64/1.1.0/base64.min"
				"https://cdn.jsdelivr.net/npm/js-base64@2.5.2/base64"
			]
			//'https://cdn.jsdelivr.net/npm/ieee-float@0.6.0/index.min'
			,buffer:"https://cdn.jsdelivr.net/npm/buffer@5.6.0/index.min"
			//,buffer:"https://cdn.jsdelivr.net/npm/buffer-js@0.0.3/buffer"
			//,Vue:"https://cdn.jsdelivr.net/npm/vue/dist/vue"
		},
		shim:{
			'vue-window':{deps: ['vue','lodash','base64-js']}
			,"base64-js":{deps:['lodash','buffer']}
		}
	};
	...
	if (typeof define === 'function' && define.amd) {
		...
		window.sample = __fn(window.$,window._);
	}
})();
