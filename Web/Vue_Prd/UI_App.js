(function (root, factory) {
...
}(this, async function ($, Vue, _,Mock,ELEMENT) {
    var _data = {
            ...
            var _vue = {
                ...
                methods:{
                   ...
                   Render_x(jdt_set=null){
                    ...
                    genCode(arg){
                        var _mock = this.mock ==null 
                        ? null
                        : `\n\tvar _mock=${JSON.stringify(this.mock,null,'\t')};`;
                        var _code =`
    ...
    <table ref="jqDT" :jdt_set="_set" ${_mock==null?'':':mock="_mock"'} class="display" width="100%"></table>
                        `;
                        return _code;
                    }
